...
function line () {
  var vertLine = `<div style="border-left:black;border-style:solid;margin-left:90%; height:${vHeight}px;width:0px;position:absolute;" id="vertLine"></div>`;
  var linePrompt = `<div id="linePrompt"><div style="font-size:50px;position:absolute;margin-left:65%;margin-top:${vHeight/2}px"></div><div style="position:absolute;margin-left:65%;margin-top:${vHeight/2}px;z-index:5;">Move mouse right of the line to begin</div></div>`
