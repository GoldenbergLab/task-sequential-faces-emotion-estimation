/**
 * jspsych-image-slider-response_noButton
...
jsPsych.plugins['image-slider-response_noButton'] = (function() {

  var plugin = {};

  jsPsych.pluginAPI.registerPreload('image-slider-response_noButton', 'stimulus', 'image');

  plugin.info = {
    name: 'image-slider-response_noButton',
    description: '',
    parameters: {
      stimulus: {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    // add submit button
    //html += '<button id="jspsych-image-slider-response_noButton-next" class="jspsych-btn">'+trial.button_label+'</button>';
    ...
    display_element.querySelector('#jspsych-image-slider-response_noButton-response_noButton').addEventListener('click', function() {
      // measure response time
      var endTime = (new Date()).getTime();
      response.rt = endTime - startTime;
      response.response = display_element.querySelector('#jspsych-image-slider-response_noButton-response_noButton').value;

      if(trial.response_ends_trial){
        end_trial();
      } else {
        display_element.querySelector('#jspsych-image-slider-response_noButton-response_noButton').disabled = true;
      }
    ...
    if (trial.stimulus_duration !== null) {
      jsPsych.pluginAPI.setTimeout(function() {
        display_element.querySelector('#jspsych-image-slider-response_noButton-stimulus').style.visibility = 'hidden';
